                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                user_info = [name, date_time_string, "clocked in"]
                                cur.execute('INSERT INTO attendance (name, date, status) VALUES (?,?,?)', user_info)
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                user_info = [name, date_time_string, "clocked out"]
                                cur.execute('INSERT INTO attendance (name, date, status) VALUES (?,?,?)', user_info)
